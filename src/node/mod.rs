...
pub(super) const MAX_COMPETING_MSG1: u32 = 3;
...
pub struct Node {
    ...
    configured_peer_addrs: HashSet<NodeAddr>,
    ...
    competing_msg1_counts: HashMap<NodeAddr, u32>,
...
impl Node {
    ...
    pub fn new(config: Config) -> Result<Self, NodeError> {
        ...
        let configured_peer_addrs: HashSet<NodeAddr> = config
            .peers()
            .iter()
            .filter_map(|pc| PeerIdentity::from_npub(&pc.npub).ok())
            .map(|id| *id.node_addr())
            .collect();
        ...
        Ok(Self {
            ...
            competing_msg1_counts: HashMap::new(),
    ...
    pub fn with_identity(identity: Identity, config: Config) -> Self {
        ...
        Self {
            ...
            connections: HashMap::new(),
            peers: HashMap::new(),
            configured_peer_addrs: HashSet::new(),
            sessions: HashMap::new(),
            identity_cache: HashMap::new(),
            pending_tun_packets: HashMap::new(),
            pending_lookups: HashMap::new(),
    ...
    async fn create_transports(
        &mut self,
        packet_tx: &PacketTx,
        #[allow(unused_variables)] disconnect_tx: &DisconnectTx,
    ) -> Vec<TransportHandle> {
